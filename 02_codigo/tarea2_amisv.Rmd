...
## <b style = 'color : #11bd33; font-size: 25px;'>
Definición de un loop o bucle </b> 
...
## <b style = 'color : #11bd33; font-size: 25px;'>
Descripción del ejemplo de clase CONAGUA </b> 
...
```{r eval=FALSE}
# Descarga n = 2
bd <- read_table2("https://smn.conagua.gob.mx/tools/RESOURCES/Diarios/9008.txt", 
                  skip = 20) %>% 
...
## <b style = 'color : #11bd33; font-size: 25px;'> 
Descripción de pasos para descarga de datos de INEGI </b> 
...
curl::curl_download(url = "https://www.inegi.org.mx/contenidos/programas/intercensal/2015/tabulados/14_vivienda_mor.xls", 
                    destfile = # Con este argumento le indicamos a R la ruta para guardar nuestro archivo. Aquí podemos especificar el nombre del archivo después de la carpeta en la que lo vamos a guardar.
...
¡Saludos! </b>
 ...
 ![](https://media.giphy.com/media/wKzqplM46EklYVVToJ/giphy.gif)